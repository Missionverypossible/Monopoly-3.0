Public Class Form2
    ...
    Dim jail As Boolean = False 'The boolean to test if Player has been arrested
    ...
    Sub Afterrolldiceplayer1() 'The codes that shows what is happening when the player1 is on that certain point
        ...
        If Player1.Location = imagelocation(2) Then 'When Player1 is on the Chance 
            chance = rnd.Next(1, 4) 'There are 4 possible solutions end up happening by random draw
            If chance = 1 Then
        ...
        If Player1.Location = imagelocation(4) Then 'When Player1 is on Montreal
            ...
            Else    'If no one bought Montreal
                MessageBox.Show("You are in Montreal. The price for this land is $300 and you gain $100 if someone else is on it.", "Government of Montreal")
        ...
        If Player1.Location = imagelocation(5) Then 'When Player1 is on the Go to Jail
            ...
            jail = True 'The variable changed, so that it tells Player1 is arrested
        ...
        If Player1.Location = imagelocation(7) Then 'When Player1 is on the Community Chest
            communitychest = rnd.Next(1, 4) '4 different kinds of things happening by random draw
        ...
        If Player1.Location = imagelocation(8) Then 'When Player1 is on Beijing
            If beijingplayer1 = True Or beijingplayer2 = True Then
                If beijingplayer2 = True Then   'When Player2 has already bought Beijing
                    ...
                    End If
                End If
                If torontoplayer1 = True Then   'When Player1 has already bought Beijing
                    If Player1.Location = imagelocation(8) Then
                        BtnBuyBeijing.Enabled = False
                        MessageBox.Show("Welcome back")
                    End If
        ...
        If Player1.Location = imagelocation(10) Then    'When Player1 is on Chance 
            chance = rnd.Next(1, 4) '4 different kinds of things happening by random draw
            If chance = 1 Then
                MessageBox.Show("You found a wallet on the street! You gain $100!", "Chance")
                player1money += 100
                player1position = 10
        ...
        If Player1.Location = imagelocation(12) Then    'When Player1 is in jail
            If jail = True Then
                If player1injail = True Then
                    MessageBox.Show("Player1 is still in jail.")
                    player1position = 12
                    BtnEndTurn.Enabled = True
                    BtnRollDice.Enabled = False
                ElseIf player1injail = False Then
    ...
    Sub Afterrolldiceplayer2()  'These codes show what is happening to Player2 at certain point
        ...
        If Player2.Location = imagelocation(4) Then
            If montrealplayer1 = True Or montrealplayer2 = True Then
                ...
                End If
            Else
                MessageBox.Show("You are in Montreal. The price for this land is $300 and you gain $75 if someone else is on it.", "Government of Toronto")
                BtnBuyMontreal.Enabled = True
            End If
        End If
    ...
    End Sub
    Sub player1shift()
        If player1position + player1movement > 14 Then  'This is how we move Player1
    ...
    End Sub
    Sub player2shift()
        If player2position + player2movement > 14 Then  'This is how we move Player2
    ...
    Private Sub BtnEndTurn_Click(sender As Object, e As EventArgs) Handles BtnEndTurn.Click
        ...
        If player1injail = True Then    'If Player is still in Jail 
            MessageBox.Show("Player1 is still in jail.")
            player1position = 12
            BtnEndTurn.Enabled = True
            BtnRollDice.Enabled = False
            player1injail = False
        ElseIf player2injail = True Then
